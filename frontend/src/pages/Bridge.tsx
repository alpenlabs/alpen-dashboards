              ...
              <div className="bridge-container">
                  ...
                  {data && data.operators.length > 0 ? (
                    <div className="table-wrapper">
                      <table className="operators-table">
                        ...
                        <tbody>
                          {data.operators.map(
                            (operator: OperatorStatus, index: number) => (
                              <tr key={index} className="operators-row">
                                <td className="table-cell">
                                  {operator.operator_id}
                                </td>
                                <td className="table-cell">
                                  {truncateHex(operator.operator_pk)}
                                </td>
                                <td
                  ...
                  {data && data.deposits.length > 0 ? (
                    <div className="table-wrapper">
                      <table className="transactions-table">
                        ...
                        <tbody>
                          {data.deposits.map(
                            (deposit: DepositInfo, index: number) => (
                              <tr key={index} className="transactions-row">
                                <td className="table-cell">
                                  <TxidDisplay
                                    explorerUrl={bitcoinExplorerUrl}
                                    txid={deposit.deposit_request_txid}
                                  />
                                </td>
                                <td className="table-cell">
                                  <TxidDisplay
                                    explorerUrl={bitcoinExplorerUrl}
                                    txid={deposit.deposit_txid}
                                  />
                                </td>
                      ...
                      <table className="transactions-table">
                        ...
                        <tbody>
                          {data.withdrawals.map(
                            (withdrawal: WithdrawalInfo, index: number) => (
                              <tr key={index} className="transactions-row">
                                <td className="table-cell">
                                  <TxidDisplay
                                    explorerUrl={alpenExplorerUrl}
                                ...
                                <td className="table-cell">
                                  <TxidDisplay
                                    explorerUrl={bitcoinExplorerUrl}
                                    txid={withdrawal.fulfillment_txid}
                                  />
                                </td>
                                <td className="table-cell">
                                  {withdrawal.status}
                ...
                <div className="bridge-section">
                  ...
                  {data && data.reimbursements.length > 0 ? (
                            ...
                            (
                              ...
                              <tr key={index} className="transactions-row">
                                ...
                                <td className="table-cell">
                                  <TxidDisplay
                                    explorerUrl={bitcoinExplorerUrl}
                                    txid={reimbursement.payout_txid}
                                  />
                                </td>
                                <td className="table-cell">
                    ...
                    <p className="no-items">No bridge reimbursements found.</p>
                  )}
                </div>
              </div>
            )}
