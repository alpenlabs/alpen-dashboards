  ...
  const faucetWallets = [
    {
      ...
      threshold_sats: config.faucetBalanceThresholds.signet * 100_000_000, // Convert BTC to sats
    },
    {
      name: 'Alpen wallet',
      balance_sats: faucet.l2_balance_sats,
      threshold_sats: config.faucetBalanceThresholds.alpen * 100_000_000, // Convert BTC to sats
    },
  ];
