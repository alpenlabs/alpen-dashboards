...
"#;
    ...
    fn test_load_from_path() {
        ...
        assert_eq!(config.network.retry_policy_max_retries, 5);
        assert_eq!(config.network.retry_policy_total_time_s, 60);
...
"#;
        ...
        assert_eq!(config.network.retry_policy_max_retries, 3);
        assert_eq!(config.network.retry_policy_total_time_s, 30);
